...
COPY --from=builder --chown=nodejs:nodejs /app/omnicore-auth/node_modules ./omnicore-auth/node_modules
...
# Service source code
COPY --chown=nodejs:nodejs omnicore-auth/ ./omnicore-auth/

USER nodejs

WORKDIR /app/omnicore-auth
